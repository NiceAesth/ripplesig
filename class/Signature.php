...
class Signature
{
	...
	public function output() {
		...
		$this->canvas->setImageProperty('Generated by', 'Lemmmy\'s osu!next signature generator, modified for ripple');
		$this->canvas->setImageProperty('Generator URL', 'http://sig.ripple.moe/');
