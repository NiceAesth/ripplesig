...
class Signature
{
	...
	public function output() {
		...
		$this->canvas->setImageProperty('Generated by', 'Lemmmy\'s osu!next signature generator, modified for Sirohi');
		$this->canvas->setImageProperty('Generator URL', 'https://sig.sirohi.xyz/');
